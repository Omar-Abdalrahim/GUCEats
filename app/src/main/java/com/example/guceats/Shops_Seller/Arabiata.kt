...
class Arabiata : AppCompatActivity() {
                    ...
                    shopdbref.child(title as String).addListenerForSingleValueEvent(object : ValueEventListener {
                        override fun onDataChange(snapshot: DataSnapshot) {
                            if (snapshot.hasChild("Data")) {
                                ...
                                Toast.makeText(this@Arabiata,"You must complete the shop information to continue",Toast.LENGTH_SHORT).show()
                                val i = Intent(this@Arabiata, Shop_data::class.java)
                        ...
                        override fun onCancelled(error: DatabaseError) {
                            Toast.makeText(this@Arabiata,"Error in database",Toast.LENGTH_SHORT).show()
                        }
    ...
    private  fun loadFragment(fragment: Fragment){
        ...
        transaction.replace(R.id.arabiataContainerView,fragment)
        transaction.commit()
    }
