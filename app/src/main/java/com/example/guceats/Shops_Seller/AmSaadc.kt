...
class AmSaadc : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_am_saadc)
                    ...
                    shopdbref.child(title as String).addListenerForSingleValueEvent(object : ValueEventListener {
                        override fun onDataChange(snapshot: DataSnapshot) {
                            if (snapshot.hasChild("Data")) {
                                ...
                                Toast.makeText(this@AmSaadc,"You must complete the shop information to continue",Toast.LENGTH_SHORT).show()
                                val i = Intent(this@AmSaadc, Shop_data::class.java)
                        ...
                        override fun onCancelled(error: DatabaseError) {
                            Toast.makeText(this@AmSaadc,"Error in database",Toast.LENGTH_SHORT).show()
                        }
    ...
    private  fun loadFragment(fragment: Fragment){
        ...
        transaction.replace(R.id.amsaadcContainerView,fragment)
        transaction.commit()
    }
