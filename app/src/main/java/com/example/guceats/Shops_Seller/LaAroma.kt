                    ...
                    shopdbref.child(title as String).addListenerForSingleValueEvent(object : ValueEventListener {
                        override fun onDataChange(snapshot: DataSnapshot) {
                            if (snapshot.hasChild("Data")) {
                                ...
                                Toast.makeText(this@LaAroma,"You must complete the shop information to continue",Toast.LENGTH_SHORT).show()
                                val i = Intent(this@LaAroma, Shop_data::class.java)
                        ...
                        override fun onCancelled(error: DatabaseError) {
                            Toast.makeText(this@LaAroma,"Error in database",Toast.LENGTH_SHORT).show()
                        }
