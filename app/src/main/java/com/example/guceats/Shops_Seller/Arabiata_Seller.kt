...
private var adapter=ItemsAdaptor(items)
class Arabiata_Seller : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_arabiata__seller, container, false)
        val adapter = ItemsAdaptor(items)
        val rvprod = view.findViewById<View>(R.id.arabiatarec) as RecyclerView
    ...
    private fun getMenu(){
        shopdbref.child("Arabiata").child("Menu").addValueEventListener(object: ValueEventListener {
