                    ...
                    shopdbref.child(title as String).addListenerForSingleValueEvent(object : ValueEventListener {
                        override fun onDataChange(snapshot: DataSnapshot) {
                            if (snapshot.hasChild("Data")) {
                                ...
                                Toast.makeText(this@AmSaadb,"You must complete the shop information to continue",Toast.LENGTH_SHORT).show()
                                val i = Intent(this@AmSaadb, Shop_data::class.java)
                        ...
                        override fun onCancelled(error: DatabaseError) {
                            Toast.makeText(this@AmSaadb,"Error in database",Toast.LENGTH_SHORT).show()
                        }
