...
class AmSaadb_Seller : Fragment() {
    ...
    override fun onCreateView(
        ...
        getMenu()
        val view=inflater.inflate(R.layout.fragment_am_saadb__seller, container, false)
        val adapter = ItemsAdaptor(items)
        val rvprod = view.findViewById<View>(R.id.amsaadbrec) as RecyclerView
    ...
    private fun getMenu(){
        shopdbref.child("3amsaad(B)").child("Menu").addValueEventListener(object: ValueEventListener {
